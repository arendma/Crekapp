...
[viri_Kcats, viri_Kcat_matches]=matchKcats(model_irrev, 'Data/kcats/kcats-full-lineages.tsv', 'Chlamydomonas', 'Viridiplantae', false);
[euk_Kcats, euk_Kcat_matches]=matchKcats(model_irrev, 'Data/kcats/kcats-full-lineages.tsv', 'Viridiplantae', 'Eukaryota', false);
[proc_Kcats, proc_Kcat_matches]=matchKcats(model_irrev, 'Data/kcats/kcats-full-lineages.tsv', 'Cyanobacteria', 'Bacteria', false);
...
% res_31_p=struct();
res_hamm_p.flux=my_pFBA(model_irrev,lb,ub,scale); 
res_hamm_n=NIDLE(model_irrev,g_vect,lb,ub,1e-4,scale, feasTol, 128,1);

%Computing Kapp

[Kapp_hamm_p,V_hamm_p,count_hamm_p]=getkapp(abundance,g_vect, res_hamm_p.flux,model_irrev, lit_kcats, conv,1e-4,(3600*1e-10), 'Results/pFBA/kcat_p');
[Kapp_hamm_n,V_hamm_n,count_hamm_n]=getkapp(abundance,g_vect,res_hamm_n.flux,model_irrev, lit_kcats,conv,1e-4,(3600*1e-10), 'Results/NIDLE/kcat_n');

%print summary of kapp statistics and fluxes
printSummary(model_irrev, ub,count_hamm_p, V_hamm_p, conditions.cond, 'Results/pFBA/pFBA_flux')
printSummary(model_irrev, ub,count_hamm_n, V_hamm_n, conditions.cond, 'Results/NIDLE/NIDLE_flux')
